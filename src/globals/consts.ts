...
export const BRAND_NAME = "ZYinfo.pro AI coder";
...
export const PROJECT_OPEN_GITHUB_COMMAND = "ZYAICoder::openGithub";
...
export const PROJECT_GITHUB_URL = "https://github.com/hayooucom/zy-ai-coder";
...
export const OUTPUT_CHANNEL_NAME = "ZYinfo.pro AI coder";